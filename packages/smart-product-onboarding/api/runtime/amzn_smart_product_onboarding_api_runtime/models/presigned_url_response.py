...
class PresignedUrlResponse(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The presigned URL for interacting with S3 (downloading or uploading)")
    object_key: Optional[StrictStr] = Field(default=None, alias="objectKey", description="The optional object key")
    __properties: ClassVar[List[str]] = ["url", "objectKey"]

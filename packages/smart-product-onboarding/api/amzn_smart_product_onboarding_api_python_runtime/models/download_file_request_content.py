...
class DownloadFileRequestContent(BaseModel):
    ...
    expiration: Optional[Union[Annotated[float, Field(le=300, strict=True, ge=15)], Annotated[int, Field(le=300, strict=True, ge=15)]]] = Field(default=None, description="The expiration, in seconds for the generated URL")

...
class CreateBatchExecutionRequestContent(BaseModel):
    """
    CreateBatchExecutionRequestContent
    """ # noqa: E501
    input_file: StrictStr = Field(alias="inputFile", description="The s3 key for the csv file containing the input data")
    compressed_images_file: Optional[StrictStr] = Field(default=None, alias="compressedImagesFile", description="The s3 key for the zip file containing the product images")
    __properties: ClassVar[List[str]] = ["inputFile", "compressedImagesFile"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "compressedImagesFile": obj.get("compressedImagesFile")
        })
        return _obj

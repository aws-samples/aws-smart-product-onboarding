...
class ExtractAttributesResponseContent(BaseModel):
    """
    ExtractAttributesResponseContent
    """ # noqa: E501
    attributes: Annotated[List[ProductAttribute], Field(strict=True, max_length=100)]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "attributes": [ProductAttribute.from_dict(_item) for _item in obj.get("attributes")] if obj.get("attributes") is not None else None
        })
        return _obj
